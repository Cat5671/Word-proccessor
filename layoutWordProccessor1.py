...
class Ui_WordProcessor(object):
    def setup_ui(self, WordProccessor):
        ...
        spacer_item13 = QtWidgets.QSpacerItem(5, 20, QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Minimum)
        self.word_proccessor_layout.addItem(spacer_item13)
        spacer_item14 = QtWidgets.QSpacerItem(15, 20, QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Minimum)
