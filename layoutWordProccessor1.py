...
class Ui_WordProcessor(object):
    def setup_ui(self, WordProccessor):
        ...
        self.underline_text_button.setText("")
        ...
        self.fonts = QtWidgets.QComboBox(self.central_widget)
        ...
        self.italic_text_button.setText("")
    ...
    def retranslateUi(self, WordProccessor):
        ...
        self.fonts.setItemText(0, _translate("WordProccessor", "Calibri"))
        self.fonts.setItemText(1, _translate("WordProccessor", "Arial"))
        self.fonts.setItemText(2, _translate("WordProccessor", "Times New Roman"))
        self.fonts.setItemText(3, _translate("WordProccessor", "Verdana"))
        self.fonts.setItemText(4, _translate("WordProccessor", "Tahoma"))
